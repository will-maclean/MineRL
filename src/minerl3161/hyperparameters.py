...
class DQNHyperparameters(BaseHyperparameters):
    ...
    hard_update_freq: Union[int, None] = 1000   # how ofter to do a hard copy from q1 to q2
    soft_update_freq: Union[int, None] = 1      # how often to do a soft update from q1 to q2
